...
export declare class IssueCustomFieldAssociations {
     ...
     */
    createAssociations<T = void>(parameters: Parameters.CreateAssociations, callback: Callback<T>): Promise<void>;
    /**
     * @experimental
     * Associates fields with projects.
     *
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    removeAssociations<T = void>(parameters: Parameters.RemoveAssociations, callback: Callback<T>): Promise<void>;
    /**
     * @experimental
     * Unassociates a set of fields with a project and issue type context.
     *
