...
export declare class MigrationOfConnectModulesToForge {
    private client;
     ...
     */
    fetchMigrationTask<T = Models.TaskProgress>(parameters: Parameters.FetchMigrationTask, callback: Callback<T>): Promise<void>;
    /**
     * Returns the details of a Connect issue field's migration to Forge.
     *
     * When migrating a Connect app to Forge, [Issue
     ...
     * Connect and Forge apps can make this request.
     */
    fetchMigrationTask<T = Models.TaskProgress>(parameters: Parameters.FetchMigrationTask, callback?: never): Promise<T>;
}
