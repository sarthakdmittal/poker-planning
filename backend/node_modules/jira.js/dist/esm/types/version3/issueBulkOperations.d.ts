...
export declare class IssueBulkOperations {
     ...
     *   to view the issue.
     */
    submitBulkUnwatch<T = Models.SubmittedBulkOperation>(parameters: Parameters.SubmitBulkUnwatch, callback: Callback<T>): Promise<void>;
    /**
     * Use this API to submit a bulk unwatch request. You can unwatch up to 1,000 issues in a single operation.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:**
     ...
     *   to view the issue.
     */
    submitBulkUnwatch<T = Models.SubmittedBulkOperation>(parameters: Parameters.SubmitBulkUnwatch, callback?: never): Promise<T>;
    /**
     ...
     *   to view the issue.
     */
    submitBulkWatch<T = Models.SubmittedBulkOperation>(parameters: Parameters.SubmitBulkWatch, callback: Callback<T>): Promise<void>;
    /**
     * Use this API to submit a bulk watch request. You can watch up to 1,000 issues in a single operation.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:**
     ...
     *   to view the issue.
     */
    submitBulkWatch<T = Models.SubmittedBulkOperation>(parameters: Parameters.SubmitBulkWatch, callback?: never): Promise<T>;
    /**
