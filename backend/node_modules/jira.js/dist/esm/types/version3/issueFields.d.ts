...
export declare class IssueFields {
     ...
     * Permission to access Jira.
     */
    getProjectFields<T = Page<typeof Models.ProjectFieldSchema>>(parameters: Parameters.GetProjectFields, callback: Callback<T>): Promise<void>;
    /**
     * @experimental
     *
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#pagination) list of fields
     ...
     * Permission to access Jira.
     */
    getProjectFields<T = Page<typeof Models.ProjectFieldSchema>>(parameters: Parameters.GetProjectFields, callback?: never): Promise<T>;
}
