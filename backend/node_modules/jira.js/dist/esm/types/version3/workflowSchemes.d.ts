...
export declare class WorkflowSchemes {
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    switchWorkflowSchemeForProject<T = unknown>(parameters: Parameters.SwitchWorkflowSchemeForProject, callback: Callback<T>): Promise<void>;
    /**
     * @experimental
     *
     * Switches a workflow scheme for a project.
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    switchWorkflowSchemeForProject<T = unknown>(parameters: Parameters.SwitchWorkflowSchemeForProject, callback?: never): Promise<T>;
    /**
