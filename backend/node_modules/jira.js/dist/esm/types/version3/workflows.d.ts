...
export declare class Workflows {
     ...
     */
    readWorkflowFromHistory<T = Models.WorkflowHistoryReadResponse>(parameters: Parameters.ReadWorkflowFromHistory, callback: Callback<T>): Promise<void>;
    /**
     * Returns a workflow and related statuses for a specified workflow id and version number.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:**
     ...
     *   project-scoped workflows
     */
    readWorkflowFromHistory<T = Models.WorkflowHistoryReadResponse>(parameters: Parameters.ReadWorkflowFromHistory, callback?: never): Promise<T>;
    /**
     ...
     *   project-scoped workflows
     */
    listWorkflowHistory<T = Models.WorkflowHistoryListResponse>(parameters: Parameters.ListWorkflowHistory, callback: Callback<T>): Promise<void>;
    /**
     * Returns a list of workflow history entries for a specified workflow id.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:**
     ...
     *   project-scoped workflows
     */
    listWorkflowHistory<T = Models.WorkflowHistoryListResponse>(parameters: Parameters.ListWorkflowHistory, callback?: never): Promise<T>;
    /**
    ...
    getDefaultEditor<T = Models.DefaultWorkflowEditorResponse>(callback: Callback<T>): Promise<void>;
    /** Get the user's default workflow editor. This can be either the new editor or the legacy editor. */
    getDefaultEditor<T = Models.DefaultWorkflowEditorResponse>(callback?: never): Promise<T>;
    /**
     ...
     */
    readWorkflowPreviews<T = Models.WorkflowPreviewResponse>(parameters: Parameters.ReadWorkflowPreviews, callback: Callback<T>): Promise<void>;
    /**
     * Returns a requested workflow within a given project. The response provides a read-only preview of the workflow,
     * omitting full configuration details.
     *
     ...
     * - At least one of the _Administer projects_ and _View (read-only) workflow_ project permissions
     */
    readWorkflowPreviews<T = Models.WorkflowPreviewResponse>(parameters: Parameters.ReadWorkflowPreviews, callback?: never): Promise<T>;
    /**
