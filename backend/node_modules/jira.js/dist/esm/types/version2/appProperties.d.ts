...
export declare class AppProperties {
     ...
     * requests from Forge.
     */
    getForgeAppPropertyKeys<T = Models.GetForgeAppPropertyKeys>(callback: Callback<T>): Promise<void>;
    /**
     * Returns all property keys for the Forge app.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#permissions) required:** Only
     ...
     * requests from Forge.
     */
    getForgeAppPropertyKeys<T = Models.GetForgeAppPropertyKeys>(callback?: never): Promise<T>;
    /**
     ...
     * requests from Forge.
     */
    getForgeAppProperty<T = Models.GetForgeAppProperty>(parameters: Parameters.GetForgeAppProperty, callback: Callback<T>): Promise<void>;
    /**
     * Returns the value of a Forge app's property.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#permissions) required:** Only
     ...
     * requests from Forge.
     */
    getForgeAppProperty<T = Models.GetForgeAppProperty>(parameters: Parameters.GetForgeAppProperty, callback?: never): Promise<T>;
    /**
