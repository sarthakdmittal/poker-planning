...
export declare class IssueCustomFieldAssociations {
    private client;
     ...
     */
    createAssociations<T = void>(parameters: Parameters.CreateAssociations | undefined, callback: Callback<T>): Promise<void>;
    /**
     * Associates fields with projects.
     *
     * Fields will be associated with each issue type on the requested projects.
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    createAssociations<T = void>(parameters?: Parameters.CreateAssociations, callback?: never): Promise<T>;
    /**
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    removeAssociations<T = void>(parameters: Parameters.RemoveAssociations | undefined, callback: Callback<T>): Promise<void>;
    /**
     * Unassociates a set of fields with a project and issue type context.
     *
     * Fields will be unassociated with all projects/issue types that share the same field configuration which the
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    removeAssociations<T = void>(parameters?: Parameters.RemoveAssociations, callback?: never): Promise<T>;
}
