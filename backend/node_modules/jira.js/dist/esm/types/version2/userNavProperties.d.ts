...
export declare class UserNavProperties {
    private client;
     ...
     */
    getUserNavProperty<T = Models.UserNavProperty>(parameters: Parameters.GetUserNavProperty, callback: Callback<T>): Promise<void>;
    /**
     * Returns the value of a user nav preference.
     *
     * Note: This operation fetches the property key value directly from RbacClient.
     ...
     * - Access to Jira, to get a property from the calling user's record.
     */
    getUserNavProperty<T = Models.UserNavProperty>(parameters: Parameters.GetUserNavProperty, callback?: never): Promise<T>;
    /**
     ...
     */
    setUserNavProperty<T = unknown>(parameters: Parameters.SetUserNavProperty, callback: Callback<T>): Promise<void>;
    /**
     * Sets the value of a Nav4 preference. Use this resource to store Nav4 preference data against a user in the Identity
     * service.
     *
     ...
     * - Access to Jira, to set a property on the calling user's record.
     */
    setUserNavProperty<T = unknown>(parameters: Parameters.SetUserNavProperty, callback?: never): Promise<T>;
}
