...
export declare class IssueFields {
     ...
     */
    getProjectFields<T = Models.PageProjectField>(parameters: Parameters.GetProjectFields, callback: Callback<T>): Promise<void>;
    /**
     * @experimental
     *
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#pagination) list of fields
     ...
     * Permission to access Jira.
     */
    getProjectFields<T = Models.PageProjectField>(parameters: Parameters.GetProjectFields, callback?: never): Promise<T>;
}
