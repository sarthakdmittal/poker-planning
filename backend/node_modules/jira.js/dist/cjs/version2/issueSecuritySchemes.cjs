    ...
    async getSecurityLevels(parameters, callback) {
        const config = {
            ...
            params: {
                ...
                id: paramSerializer.paramSerializer('id', parameters?.id),
                schemeId: paramSerializer.paramSerializer('schemeId', parameters?.schemeId),
    ...
    async getSecurityLevelMembers(parameters, callback) {
        const config = {
            ...
            params: {
                ...
                id: paramSerializer.paramSerializer('id', parameters?.id),
                schemeId: paramSerializer.paramSerializer('schemeId', parameters?.schemeId),
                levelId: paramSerializer.paramSerializer('levelId', parameters?.levelId),
    ...
    async searchSecuritySchemes(parameters, callback) {
        const config = {
            ...
            params: {
                ...
                maxResults: parameters?.maxResults,
                id: paramSerializer.paramSerializer('id', parameters?.id),
                projectId: paramSerializer.paramSerializer('projectId', parameters?.projectId),
            },
        };
        return this.client.sendRequest(config, callback);
    }
...
//# sourceMappingURL=issueSecuritySchemes.cjs.map
