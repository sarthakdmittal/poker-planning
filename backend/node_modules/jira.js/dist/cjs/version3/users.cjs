...
class Users {
    ...
    async bulkGetUsers(parameters, callback) {
        const config = {
            ...
            params: {
                ...
                accountId: paramSerializer.paramSerializer('accountId', parameters.accountId),
            },
        };
        return this.client.sendRequest(config, callback);
    }
    async bulkGetUsersMigration(parameters, callback) {
        const config = {
            ...
            method: 'GET',
            params: {
                key: paramSerializer.paramSerializer('key', parameters.key),
                maxResults: parameters.maxResults,
                startAt: parameters.startAt,
                username: paramSerializer.paramSerializer('username', parameters.username),
            },
        };
        return this.client.sendRequest(config, callback);
    }
